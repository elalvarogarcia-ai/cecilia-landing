...
const CHAT_MESSAGES = [
  ...
  {
    from: 'cecilia',
    card: { title: 'Casa Valle Real', detail: '4 rec · 3 baños · 320 m²', price: '$4,850,000 MXN', tag: 'Disponible' },
  },
...
const STEPS = [
  {
    ...
    desc: 'El cliente inicia la conversación con cualquier pregunta sobre propiedades. Cecilia responde de inmediato, en cualquier horario.',
  },
  {
    num: '02',
    icon: '🏠',
    title: 'Cecilia presenta propiedades',
    desc: 'Filtra tu catálogo según los filtros del cliente (zona, precio, recámaras) y presenta las opciones más relevantes con fotos y detalles.',
  },
  {
    num: '03',
    icon: '📅',
    title: 'Agenda la cita automáticamente',
    desc: 'Cuando el cliente muestra interés, Cecilia coordina la visita y la registra en el calendario del asesor sin intervención humana.',
  },
]
...
const FEATURES = [
  {
    ...
    bullets: [
      'Responde preguntas sobre precios, zonas y amenidades',
      'Compara propiedades según los filtros del cliente',
      'Detecta el nivel de intención de compra',
      'Transfiere a un asesor cuando es necesario',
    ],
    img: 'https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=600&q=80',
    imgAlt: 'Asesor inmobiliario atendiendo cliente',
  },
  {
    tag: 'Calificación de leads',
    title: 'Filtra y califica a tus prospectos',
    desc: 'No todos los leads son iguales. Cecilia identifica a los clientes con mayor intención de compra y los prioriza para que tus asesores enfoquen su tiempo donde más importa.',
    bullets: [
      'Clasifica leads por nivel de interés',
      'Recopila datos clave: presupuesto, zona, urgencia',
      'Genera perfiles detallados de cada prospecto',
      'Sincroniza la información con tu panel en tiempo real',
    ],
    img: 'https://images.unsplash.com/photo-1551836022-d5d88e9218df?w=600&q=80',
    imgAlt: 'Dashboard de métricas',
  },
  {
    ...
    bullets: [
      'Agenda visitas según disponibilidad del asesor',
      'Envía confirmaciones y recordatorios automáticos',
      'Reagenda si el cliente cancela',
      'Registra el resultado de cada visita',
    ],
    img: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=600&q=80',
    imgAlt: 'Agenda de citas en calendar',
  },
]
...
const TESTIMONIALS = [
  {
    name: 'Laura Martínez',
    role: 'Directora de ventas · Grupo Inmobiliario GDL',
    avatar: 'LM',
    text: 'Desde que implementamos Cecilia, nuestro equipo dejó de perder tiempo respondiendo las mismas preguntas. Las citas llegan solas y los clientes ya llegan calificados a la visita.',
  },
  {
    name: 'Roberto Sánchez',
    role: 'Asesor independiente · Zapopan',
    avatar: 'RS',
    text: 'Antes perdía leads por no contestar rápido. Ahora Cecilia los atiende en segundos y yo solo me presento a las visitas. Dupliqué mis citas en el primer mes.',
  },
  {
    name: 'Daniela Torres',
    role: 'Gerente comercial · Torres & Asociados',
    avatar: 'DT',
    text: 'Lo que más me sorprendió fue la calidad de las conversaciones. Los clientes no sienten que hablan con un bot. Varios me han preguntado cómo se llama "la chica del WhatsApp".',
  },
  {
    name: 'Alejandro Ríos',
    role: 'Broker · RE/MAX Guadalajara',
    avatar: 'AR',
    text: 'El panel de control es excelente. Puedo ver todas las conversaciones, el estatus de cada lead y las citas agendadas desde el celular. Total visibilidad del negocio.',
  },
]

const PROPERTIES = [
  { img: 'https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=400&q=80', name: 'Casa Valle Real', zone: 'Zapopan', price: '$4,850,000', beds: 4, baths: 3 },
  { img: 'https://images.unsplash.com/photo-1580587771525-78b9dba3b914?w=400&q=80', name: 'Depto Ventura Vertical', zone: 'Guadalajara', price: '$2,300,000', beds: 2, baths: 2 },
  { img: 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=400&q=80', name: 'Fracc. Solares', zone: 'Tlajomulco', price: '$3,600,000', beds: 3, baths: 3 },
]
...
function WhatsAppMockup() {
  return (
    <div className="relative">
      ...
      <div className="relative bg-white rounded-3xl shadow-2xl overflow-hidden w-72 lg:w-80"
...
export default function LandingPage() {
  return (
    <main className="min-h-screen flex flex-col bg-white">
        ...
        <div className="flex-1 flex items-center px-6 py-16 lg:px-16">
          <div className="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="flex flex-col gap-8">
              <div><Image src="/fyn_original.png" alt="ForgeYourNext" width={140} height={40} /></div>
      ...
      <section id="demo" className="py-20 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            <span className="text-sm font-semibold text-[#44CACB] uppercase tracking-widest">Proceso</span>
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mt-2">¿Cómo funciona Cecilia?</h2>
            <p className="text-gray-500 mt-3 max-w-xl mx-auto">En tres pasos simples, Cecilia convierte una conversación de WhatsApp en una cita confirmada.</p>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {STEPS.map((step) => (
              <div key={step.num} className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 flex flex-col gap-4 relative">
      ...
      {/* ══ 4. PROPIEDADES (mockup de lo que ve el cliente) ═════ */}
      <section className="py-20 px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            <span className="text-sm font-semibold text-[#44CACB] uppercase tracking-widest">Catálogo inteligente</span>
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mt-2">Así presenta Cecilia tus propiedades</h2>
            <p className="text-gray-500 mt-3 max-w-xl mx-auto">Cecilia conoce tu inventario completo y selecciona automáticamente las opciones más relevantes para cada cliente.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {PROPERTIES.map(p => (
              <div key={p.name} className="rounded-2xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto flex flex-col gap-24">
          {FEATURES.map((f, i) => (
            <div key={f.tag} className={`grid grid-cols-1 lg:grid-cols-2 gap-12 items-center ${i % 2 === 1 ? 'lg:flex lg:flex-row-reverse' : ''}`}>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-xl h-72 lg:h-80">
                <Image src={f.img} alt={f.imgAlt} fill className="object-cover" />
                <div className="absolute inset-0" style={{ background: 'linear-gradient(to top, rgba(12,100,137,0.4), transparent)' }} />
              </div>
            </div>
          ))}
        </div>
      ...
      {/* ══ 6. BIG STATS ════════════════════════════════════════ */}
      <section className="py-20 px-6" style={{ background: 'linear-gradient(135deg, #0C6489 0%, #44CACB 100%)' }}>
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            <h2 className="text-3xl lg:text-4xl font-bold text-white">Resultados que hablan por sí solos</h2>
            <p className="text-white/70 mt-3">Datos de agentes que ya trabajan con Cecilia en Guadalajara.</p>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {BIG_STATS.map(s => (
              <div key={s.label} className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 text-center border border-white/20">
      ...
      {/* ══ 7. CARACTERÍSTICAS DE CECILIA ═══════════════════════ */}
      <section className="py-20 px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            <span className="text-sm font-semibold text-[#44CACB] uppercase tracking-widest">Tu nueva asistente</span>
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mt-2">Cecilia, la asistente que nunca descansa</h2>
            <p className="text-gray-500 mt-3 max-w-xl mx-auto">Diseñada específicamente para el mercado inmobiliario mexicano, con la inteligencia de un asesor experto.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            <span className="text-sm font-semibold text-[#44CACB] uppercase tracking-widest">Testimonios</span>
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mt-2">Lo que dicen los agentes</h2>
          </div>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            <span className="text-sm font-semibold text-[#44CACB] uppercase tracking-widest">FAQ</span>
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mt-2">Preguntas frecuentes</h2>
          </div>
          <Faq />
        </div>
      </section>
      ...
      <section className="py-24 px-6" style={{ background: 'linear-gradient(135deg, #0C6489 0%, #44CACB 100%)' }}>
        <div className="max-w-3xl mx-auto text-center flex flex-col gap-6">
          ...
          <p className="text-white/80 text-lg">
            Agenda una demo y ve cómo Cecilia puede transformar la atención al cliente de tu agencia inmobiliaria.
          </p>
          ...
          <p className="text-white/50 text-sm">Sin compromiso · Respuesta inmediata</p>
        </div>
      </section>
      ...
      <footer className="bg-gray-900 py-10 px-6">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <Image src="/fyn_original.png" alt="ForgeYourNext" width={110} height={32} className="opacity-60" />
